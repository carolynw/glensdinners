        ...
        public async Task SavePost(Post post)
        {
            ...
            XDocument doc = new XDocument(
                            new XElement("post",
                                ...
                                new XElement("latitude", post.Latitude),
                                new XElement("longitude", post.Longitude),
        ...
        private void LoadPosts()
        {
            ...
            foreach (string file in Directory.EnumerateFiles(_folder, "*.xml", SearchOption.TopDirectoryOnly))
            {
                ...
                Post post = new Post()
                {
                    ...
                    Latitude = Double.Parse(ReadValue(doc, "latitude")),
                    Longitude = Double.Parse(ReadValue(doc, "longitude")),
